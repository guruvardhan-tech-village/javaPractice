...
//                double price = sc.nextDouble();
            ...
            case 2: // UPDATE
                System.out.println("Enter Update for 1.Name 2.Id");
                ...
                if (decision == 1) {
                    ...
                    String updateQuery = "update cars set name=? where Id=?";
                    ...
                    System.out.print("Enter Name to update Id: ");
                    name = sc.nextLine();

                    System.out.print("Enter new Id: ");
                    int newId = sc.nextInt();

                    String updateQuery = "update cars set Id=? where name=?";
                    PreparedStatement ps2 = con.prepareStatement(updateQuery);
